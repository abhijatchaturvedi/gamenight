...
| | Game | Players | Vibe |
|--|------|---------|------|
| 🔪 | **Killer Doctor** | 4–15 | Social deduction — lies, trust, and midnight murder |
...
- 🏠 **Room codes** — create a room, share the 6-letter code, done
...
| 🔪 Killer Doctor | Discussion time · Voting time · Night action time |
...
### ⭕ Tic Tac Toe
Classic 3×3 grid. Get three of your symbol in a row (horizontal, vertical, or diagonal) to win. X always goes first. Symbols swap each game. In match formats, first to reach the win target takes the match.
...
│   └── js/
│       ├── app.js           # Socket setup · lobby · views · rules · settings
│       ├── killerdoctor.js  # Killer Doctor client UI
